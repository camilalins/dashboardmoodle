...
<small><a class="btn btn-success btn-sm ad-click-event" href="javascript:history.go(-1)"><i class="fa fa-arrow-left" aria-hidden="true"></i> Voltar</a></small>
					<h3 class="box-title"><small>Total de Inscritos em cursos na modalidade</small> Online </h3>
				<div class="box-body">
					<div class="row">
	...
	$sql .= "WHERE path like '/25/26%' AND g.idnumber = ' ' or path like '/28/29%' AND g.idnumber = ' ' ";
