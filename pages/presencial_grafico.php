...
<small><a class="btn btn-success btn-sm ad-click-event" href="javascript:history.go(-1)"><i class="fa fa-arrow-left" aria-hidden="true"></i> Voltar</a></small>
					<h3 class="box-title"><small>Total de Inscritos em cursos na modalidade</small> Presencial </h3>
				</div>
				<div class="box-body">
					<div class="row">
	...
	$sql .= " WHERE path like '/25/35%' AND g.idnumber = ' ' or path like '/28/32%' AND g.idnumber = ' ' ";
...
?>
    //opções para exibição do gráfico
        var options = {
			width: 750,
			height: 300,
              title: 'PRESENCIAL',//titulo do gráfico
